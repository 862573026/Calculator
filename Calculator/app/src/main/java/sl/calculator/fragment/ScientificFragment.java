...
public class ScientificFragment extends Fragment {
    ...
    private Button div, mul, sub, add, equal, sin, cos, tan, log, ln, sqrt,
            square, factorial, bksp, left, right, dot, drg, c;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (scientificView == null) {
            scientificView = inflater.inflate(R.layout.fragment_scientific, container, false);
        }
        ctx = scientificView.getContext();
...
//        AllWigdetListener();
    ...
    private void InitWigdet() {
        // 获取界面元素
        tvShow = (TextView) scientificView.findViewById(R.id.tvShow);
        _drg = (Button) scientificView.findViewById(R.id._drg);
        btn[0] = (Button) scientificView.findViewById(R.id.zero);
        btn[1] = (Button) scientificView.findViewById(R.id.one);
        btn[2] = (Button) scientificView.findViewById(R.id.two);
        btn[3] = (Button) scientificView.findViewById(R.id.three);
        btn[4] = (Button) scientificView.findViewById(R.id.four);
        btn[5] = (Button) scientificView.findViewById(R.id.five);
        btn[6] = (Button) scientificView.findViewById(R.id.six);
        btn[7] = (Button) scientificView.findViewById(R.id.seven);
        btn[8] = (Button) scientificView.findViewById(R.id.eight);
        btn[9] = (Button) scientificView.findViewById(R.id.nine);
        div = (Button) scientificView.findViewById(R.id.divide);
        mul = (Button) scientificView.findViewById(R.id.mul);
        sub = (Button) scientificView.findViewById(R.id.sub);
        add = (Button) scientificView.findViewById(R.id.add);
        equal = (Button) scientificView.findViewById(R.id.equal);
        sin = (Button) scientificView.findViewById(R.id.sin);
        cos = (Button) scientificView.findViewById(R.id.cos);
        tan = (Button) scientificView.findViewById(R.id.tan);
        log = (Button) scientificView.findViewById(R.id.log);
        ln = (Button) scientificView.findViewById(R.id.ln);
        sqrt = (Button) scientificView.findViewById(R.id.sqrt);
        square = (Button) scientificView.findViewById(R.id.square);
        factorial = (Button) scientificView.findViewById(R.id.factorial);
        bksp = (Button) scientificView.findViewById(R.id.bksp);
        left = (Button) scientificView.findViewById(R.id.left);
        right = (Button) scientificView.findViewById(R.id.right);
        dot = (Button) scientificView.findViewById(R.id.dot);
        drg = (Button) scientificView.findViewById(R.id.drg);
        c = (Button) scientificView.findViewById(R.id.c);
    ...
    private void updateTheme(final Button btn) {
        int textSizePX = DensityUtil.dip2px(ctx, 5);
        ...
        public void process(String str) {
            ...
            while (i < expression.length()) {
                ...
                if (ch <= '9' && ch >= '0' || ch == '.' || ch == 'E') {
                    ...
                    ch_gai = ch;
                    UtilsLog.logE(UtilsLog.getSte(),ch + "--->" + i);
                    // 取得整个数字
                    while (i < expression.length()
                            && (ch_gai <= '9' && ch_gai >= '0' || ch_gai == '.' || ch_gai == 'E')) {
                        ch_gai = expression.charAt(i++);
                        UtilsLog.logE(UtilsLog.getSte(),"i的值为：" + i);
                    }
                    // 将指针退回之前的位置
